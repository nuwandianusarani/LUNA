        ...
        <div className=" grid md:grid-cols-3 py-5">
          ...
          <div className=" py-8 px-4 ">
            ...
            <p className="text-gray-400">
              Your Virtual{" "}
              <span className=" text-white font-bold "> Universe</span> Awaits.{" "}
            </p>
            <br />
            {/* Email Subscription */}
            <div className="flex items-center h-10">
              <input
                ...
                placeholder="Email"
              />
              <button className="bg-blue-500 hover:bg-blue-500/75 h-full inline-block py-2 px-6 text-white">
                Ok
              </button>
            </div>
          </div>
            ...
            <div className="">
              <div className="py-8 px-4 ">
                ...
                <ul className={`flex flex-col gap-3 `}>
                  ...
                  <li className="cursor-pointer">Earth</li>
        ...
        <div className="hidden sm:block">
          <div className="flex justify-between items-center text-center py-6 border-t-2 border-gray-300/40">
            ...
            <span className="text-sm text-gray-400">
              @copyright 2024 || Application FrameWork
            </span>
            {/* Social Media Icons */}
